...
TEST_P(BufferedReaderTestCopy, testBufferedReaderWithReadLineOnly) {
  auto chunkSize = GetParam();

  runBufferedReaderTestForReadLineOnly(chunkSize);
}

TEST_P(BufferedReaderTestCopy, testBufferedReaderWithReadAndReadLine) {
  auto chunkSize = GetParam();
...
INSTANTIATE_TEST_SUITE_P(
    BufferedReaderTestCopy,
    BufferedReaderTestCopy,
    ::testing::Values(1, 10, 40, 100, 200, 500, 1000, 4096),
    [](const testing::TestParamInfo<BufferedReaderTestCopy::ParamType>& info) {

...
void addLiftMetricsToEmpVector(
  ...
  v.add(metrics.testValueSquared);
  v.add(metrics.controlValueSquared);
  v.add(metrics.testNumConvSquared);
  v.add(metrics.controlNumConvSquared);
...
LiftMetrics genLiftMetricsFromVector(
  ...
  metrics.testValueSquared = v[index++];
  metrics.controlValueSquared = v[index++];
  metrics.testNumConvSquared = v[index++];
  metrics.controlNumConvSquared = v[index++];
...
void addLiftMetricsToEmpVector(
  ...
  v.push_back(metrics.testValueSquared);
  v.push_back(metrics.controlValueSquared);
  v.push_back(metrics.testNumConvSquared);
  v.push_back(metrics.controlNumConvSquared);

...
TEST(MetricsMapperTest, TestXorMetrics) {
  GroupedLiftMetrics expectedMetrics{
      LiftMetrics{0, 0, 0, 0, 0, 0, 0, 0, 0},
      std::vector<LiftMetrics>{LiftMetrics{0, 0, 0, 0, 0, 0, 0, 0, 0}}};

  GroupedLiftMetrics inputMetrics{
      LiftMetrics{1, 2, 3, 4, 5, 6, 7, 8, 9},
      std::vector<LiftMetrics>{LiftMetrics{1, 2, 3, 4, 5, 6, 7, 8, 9}}};
